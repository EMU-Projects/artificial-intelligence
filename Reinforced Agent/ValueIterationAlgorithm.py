        ...
        if s not in ObstacleStates and s not in TerminalStates:            
            ...
            for a in Actions[s]:
                ...
                for NextState in StateTransitionProbs[(s,a)]:
                    ...
                    SumOverNextStates += NextStateTransProb*Old_V[NextState]
                SumOverActions += Policy[(s,a)]*(Rewards[s,a]+GAMMA*SumOverNextStates)
            V[s]=SumOverActions
    Iteration += 1
    for s in V.keys():
